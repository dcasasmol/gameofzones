...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'foursquare_venue', 'name', self.gf('django.db.models.fields.CharField')(max_length=60))

    def backwards(self, orm):

        # Changing field 'Venue.name'
        db.alter_column(u'foursquare_venue', 'name', self.gf('django.db.models.fields.CharField')(max_length=40))
