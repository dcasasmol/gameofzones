...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'User.photo'
        db.alter_column(u'foursquare_user', 'photo', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):

        # Changing field 'User.photo'
        db.alter_column(u'foursquare_user', 'photo', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        ...
        u'foursquare.user': {
            ...
            'photo': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
