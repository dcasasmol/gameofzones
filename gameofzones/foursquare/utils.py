...
# function that returns the timestamp of a month ago
...
# function that processes the information from the user
...
# function that processes the information from the checkins
...
# function that get and process the user's checkins from the database.
